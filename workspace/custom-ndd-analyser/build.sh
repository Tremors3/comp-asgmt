...
execute_passes "loop(loop-rotate),function(loop-simplify),function(gb-custom-ndd-analyser)"
#execute_passes "loop(loop-rotate),function(gb-custom-ndd-analyser)"
#execute_passes "function(gb-custom-ndd-analyser)"
